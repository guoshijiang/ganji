...
import (
	...
	"ganji/models"
	"ganji/types"
	type_address "ganji/types/address"
	"strings"
...
func (this *UserAddressController) UpdAddress() {
	...
	var upd_address type_address.UserUpdAddressCheck
...
func (this *UserAddressController) PostDelAddress() {
	...
	var del_address type_address.UserAdddressDelCheck
